    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { Id = 1, CustomerName = "Abhishek Jat", Email = "abhijat7@gmail.com", Password = "password", Phone = "1234567890", BillingAddress = "123 Main St" },
                new Customer { Id = 2, CustomerName = "Ravi Kumar", Email = "ravikumar@gmail.com", Password = "password", Phone = "0987654321", BillingAddress = "456 Park Ave" },
